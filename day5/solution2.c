...
void outputImage(int** map, int sizex, int sizey, int maxCross){

	FILE *imageFile = fopen("out.ppm", "w");

	int steps = 255 / maxCross;
...
int makeMap(int arr[LINES_IN_FILE][4]){
	...
	outputImage(map, maxX, maxY, maxCross);	
